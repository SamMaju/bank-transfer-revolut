...
import com.moneytransfer.dao.impl.BankAccountDAOImpl;
 ...
 * H2 DAO
 */
public class H2DAOFactory extends BankDAOFactory {
	...
	private final BankAccountDAOImpl accountDAO = new BankAccountDAOImpl();
	private final TransferDAOImpl transferDAO = new TransferDAOImpl();
	private final TransferReentrantDAOImpl reentrantDAO = new TransferReentrantDAOImpl();
	...
	@Override
	public TransferReentrantDAO getReentrantDAO() {
