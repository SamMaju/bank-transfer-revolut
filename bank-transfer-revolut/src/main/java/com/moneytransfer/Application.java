...
import com.moneytransfer.service.TransferReentrantService;
...
public class Application {
	...
	public static void main(String[] args) throws Exception {
			...
			BankDAOFactory h2DaoFactory = BankDAOFactory.getDAOFactory(BankDAOFactory.H2);
	...
	private static void startService() throws Exception {
		...
		servletHolder.setInitParameter("jersey.config.server.provider.classnames",
				UserService.class.getCanonicalName() + "," + AccountService.class.getCanonicalName() + ","
						...
						+ TransferReentrantService.class.getCanonicalName() + ","
